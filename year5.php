<?php
    ...
    $student_query = "SELECT * FROM students where class = 'year5' ";
...
<head>
  ...
  <title>Year 5 - KDIS MGT SYSTEM</title>
                ...
                <!-- <tr> -->
                    ...
                    <?php $count = 0; while($student = mysqli_fetch_array($student_query_run)){ $count++; ?>
                      <tr>
                        ...
                        <td>
                          <img src="assets/img/placeholder.jpg" alt="Profile" class="rounded-circle me-4" style="height: 70px; width: 70px">
